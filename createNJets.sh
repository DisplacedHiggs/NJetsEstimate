...
eos root://cmseos.fnal.gov rm -r /store/user/kreis/displaced_bkg_jan12_fixSelOnly/nJets/
eos root://cmseos.fnal.gov mkdir -p /store/user/kreis/displaced_bkg_jan12_fixSelOnly/nJets/
eos root://cmseos.fnal.gov mkdir -p /store/user/kreis/displaced_bkg_jan12_fixSelOnly/nJets/effiFiles
...
do
  ...
  do
    ...
    do
      region=${RegionList[$k]}
      eos root://cmseos.fnal.gov mkdir -p /store/user/kreis/displaced_bkg_jan12_fixSelOnly/nJets/${var}_${prod}_${k}
	...
	echo $region
        echo $bkgFile
        eos root://cmseos.fnal.gov mkdir -p /store/user/kreis/displaced_bkg_jan12_fixSelOnly/nJets/${var}_${prod}_${k}/bkg${l}
      done
    done
  done
done
